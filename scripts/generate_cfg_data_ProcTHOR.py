...
def render_room_program_images(program_json_data_path, image_save_folder="", load_progress=True):
        ...
        for ind, (program_text, house_json, og_house_json) in enumerate(tqdm.tqdm(program_json_data)):
            ...
            # image_program_json_data.append((program_text, house_json, cam_ind_to_position, all_imgs))
            ...
            # json.dump(image_program_json_data, open("data/all_room_json_programs_ai2_train_campos.json", "w"))
            controller.stop()
